...
\subsubsection{Other variance-ratio tests}
The intuition behind the VR test is rather simple, but conducting a statistical inference using the VR test is less
straightforward. 

See \citet{charles2009variance} for a review.