...
\textbf{\citet{kim2006wild}}: \citet{kim2006wild} applied the wild bootstrap to the \citeauthor{lo1988stock} test and the \citeauthor{chow1993simple} test in 3 stages:
\begin{enumerate}
...
\end{enumerate}
Conditional on $X_t$, $X_t^*$ is a serially uncorrelated sequence with zero mean and variance $X_t^2$. Thus, 