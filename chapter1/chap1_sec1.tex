...
that this new distribution is a more robust approximation to the small-sample distribution of the VR statistic.
...
\citet{lo1990contrarian} have proved that the VR statistics are severely biased and right skewed.