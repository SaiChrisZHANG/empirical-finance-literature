...
$$MV_1=\sqrt{T}\max_{1\leq i \leq m}|M_1(K_i)|$$
...
The statistic follows the SMM distribution with $m$ and $T$ degrees of freedom, where $m$ is the number of $K$ values. To accommodate heteroskedasticity, 