...
the right-skewness problem and robust to conditional heteroscedasticity. They showed that the transformed VR statistic leads to significant gain in power against mean reverting 
alternative. They define the VR statistic based on the periodogram as:
