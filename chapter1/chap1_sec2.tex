...
\begin{align*}
    ...
    & = \underbrace{\frac{1}{N^2}\left[\iota'\Gamma_k\iota-tr(\Gamma_k)\right]}_{C_k} + \underbrace{\left(-\frac{N-1}{N}\right)tr(\Gamma_k)}_{O_k} - \underbrace{\frac{1}{N}\sum^N_{i=1}(\mu_i-\mu_m)^2}_{\sigma^2(\mu)}
\end{align*}
