...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item $N$ stocks, managed by risk-neutral specialists individually. The true value is $V_t^i\equiv V_t+\xi_t^i$, where $V_i$ and $\xi_t^i$ follow independent random walks where the innovations are i.i.d. normal: $\Delta V_t = u_t \sim \mathcal{N} (0,\sigma_u^2)$, $\Delta \xi_t^i =e_t^i \sim \mathcal{N}(0,\sigma_e^2)$
        \item Trading cost and technical delays of information dissemination:
        \begin{enumerate}
            \item[-] delayed observation: $V_t^i$ is observed at $t+1$ 
            \item[-] 
        \end{enumerate}
    \end{enumerate}  
