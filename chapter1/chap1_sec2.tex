...
\begin{enumerate}
    \item[A.] \textit{\textbf{Assumptions}}
    \begin{enumerate}
    ...
    \item[B.] \textit{\textbf{Empirical evidence}}
    ...
    information dissemination). However, bid-ask bounce would affect all orders of autocorrelations equally instead of mainly AR(1). 
\end{enumerate}