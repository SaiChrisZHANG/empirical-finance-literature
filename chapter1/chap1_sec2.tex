...
\begin{enumerate}
    ...
    as $l_t=\ln(L_t/L_{t-1})$ and $m_t=\ln(M_t/M_{t-1})$. $L_t-M_t$ measures the distance between the last trade index and the center of the then-prevailing spread and $M_t$ is
