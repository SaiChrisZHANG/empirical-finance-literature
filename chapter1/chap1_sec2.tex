...
\begin{enumerate}
    ...
    \item[-] \textbf{\textit{Nontrading}}: They examined two factors of the non-trading effect: trade frequency and degree of synchronousness. They calculated a measure of \textit{staleness}: the difference between last-trade midquote $m_t$ and the \textit{current} midquote $cm_t$: $m_t = cm_t+s_t$
\end{enumerate}
