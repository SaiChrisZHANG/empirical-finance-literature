...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item[-] \textbf{\textit{Assumption}}: Again, assume that the returns for security $i\in[1,\cdots,N]$ are generated by: $R_{i,t}=\mu_i+\beta_i\Lambda_i+\epsilon_{i,t}$. To incorporate the "non-trade" feature
        into  
    \end{enumerate} 
    \item[E]    
\end{enumerate}
