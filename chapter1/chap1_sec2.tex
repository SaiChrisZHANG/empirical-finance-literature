...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item[(1)] \textbf{see-'em-coming (SEC)}: specialists expect the upcoming order flow and raise/reduce prices as buy/sell orders arrive (bid-ask prices rise/fall as buy/sell orders peak locally, there flow)
        \item[(2)] \textbf{slow-responce-to-price-information (SRPI)}: 
    \end{enumerate} 
    \end{enumerate}
