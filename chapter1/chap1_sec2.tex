...
Now, We cannot observe $z_t$, instead, we use observed returns to infer its properties. If changes in the random walk $q_t$ and stationary components $z_t$ are uncorrelated, then
$$
\beta_T = \frac{Cov[r_{t,t+T},r_{t-T,t}]}{\sigma^2[r_{t-T,t}]}=\frac{\rho_T\sigma^2[z_{t+T}-z_t]}{\sigma^2[z_{t+T}-z_t]+\sigma^2[q_{t+T}-q_t]}
$$
