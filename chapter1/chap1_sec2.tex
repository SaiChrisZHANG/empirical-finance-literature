...
\begin{enumerate}
    \item[-] \textbf{\textit{Bid-ask bounce}}: As described above, bid-ask bounce could lower the level of AR coefficients. In 1980s, bid-ask spread increased,leanding to an increase in bounce. 
    
    To rule this explanation out, 
    
    the changes in the serial correlations of $l_t=\ln(L_t/L_{t-1})$, the return index of last-trade prices, and $m_t=\ln(M_t/M_{t-1})$,
