...
\begin{enumerate}
    ...
    \item[-] $\frac{Cov(m_{t-1},\epsilon_t)}{Var(l_t)}$ measures the covariance between past increases/decreases in the midquote index and current buys/sells. This statistic is negative and decreasing over time.
    \end{enumerate}
