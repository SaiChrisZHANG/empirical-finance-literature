...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item $N$ stocks, managed by risk-neutral specialists individually. The true value is $V_t^i\equiv V_t+\xi_t^i$, where $V_i$ and $\xi_t^i$ follow independent random walks where the mean-zero innovations are i.i.d. normal: $\Delta V_t \sim \mathcal{N} (u_t,\sigma_u^2)$, $\Delta \xi_t^i \sim \mathcal{N}(e_t^i,\sigma_e^2)$
        \item 
    \end{enumerate}  
