...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        are serially independent, but sotck $i$'s returns can be predicted with past returns of stock $j$, where $j<i$. With this cross-correlation, a contrarian strategy can still profit.
    \end{enumerate} 
    \item[D]
    \item[E]    
\end{enumerate}
