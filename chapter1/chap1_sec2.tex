...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        some zero-mean, i.i.d. common factor, $\epsilon_{i,t}$ is zero-mean, serially and cross-sectionally independent. 
        To incorporate the "non-trade" feature, in each period $t$, security $i$ has a probability of $p_i$
        into the r
    \end{enumerate} 
    \item[E]    
\end{enumerate}
