...
$$
\beta_T = \frac{Cov[r_{t,t+T},r_{t-T,t}]}{\sigma^2[r_{t-T,t}]}=\frac{\rho_T Var[z_{t+T}-z_t]}{\sigma^2[z_{t+T}-z_t]+\sigma^2[q_{t+T}-q_t]} \simeq \frac{-Var(E_t[z_{t+T}-z_t])}{\sigma^2(r_{t-T},t_t)}
$$
