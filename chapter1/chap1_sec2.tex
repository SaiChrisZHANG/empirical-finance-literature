...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Monte-Carlo experiments: They performed Monte Carlo experiments by generating 25000 sequences of 720 returns, with each return sequence generated by drawing 720 pairs of standard normal variates $(\sigma^2_{\epsilon},\sigma^2_{\nu})$. They set $\sigma^2_{\epsilon}=1$, thus the variance of returns is $1+\frac{2\sigma^2_{\nu}}{1+\rho_1}$, and the "importance" of the transitory component $p^*_t$ is $\delta = \frac{2\sigma^2_{\nu}}{(1+\rho_1)+2\sigma^2_{\nu}}$.
    \end{itemize}
\end{itemize}
