...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item[(2)] \textbf{sluggish-response-to-roder-flow (SRFI)}: The order-flow information of a given stock is incorporated into quotes for other stocks slowly over time.
        \end{enumerate}  
    \end{enumerate}
