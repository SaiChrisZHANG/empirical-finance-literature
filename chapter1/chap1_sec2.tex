...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item[-] $\frac{Cov(m_t,\epsilon_{t-1})}{Var(l_t)}$ measures the correlation between past increases in buys/sells and current increases/decreases in the midquote index.
    \end{enumerate}
