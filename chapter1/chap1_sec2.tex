...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item[-] Intuition: When returns do follow random walks, any cross-sectional 
    ...
    \item[B] \underline{\textbf{\textit{Stock market overreaction and fads}}}
    \begin{enumerate}
        \item[-] Assumption: negative self-autocorrelations and zero cross-autocorrelations, i.e., 
