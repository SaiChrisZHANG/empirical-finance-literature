...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        transitory component, the relative magnitude of $\sigma^2_{\epsilon}$ and $\sigma^2_{\nu}$, defined as $\delta$, determines the importance of the two components in return movements. $\delta$ and $\rho_1$ will determine the return series.\footnote{This model was introduced by \citet{summers1986does} }
